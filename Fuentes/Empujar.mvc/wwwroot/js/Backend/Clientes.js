    ...
    $("div[tipo=btnContainer]").on('click', 'i', function (e) {
        ...
        if (tipo == 'btnAdd' || tipo == 'btnEdit' || tipo == 'btnDel') {
            ...
            if (tipo == 'btnEdit') {
                ...
                $('#Cuit').val($(iPulsado).attr('fn'));
                $('#Telefono').val($(iPulsado).attr('fn'));
                $('#ProvinciaID').val($(iPulsado).attr('fn'));
                $('#Localidad').val($(iPulsado).attr('fn'));
                $('#Observaciones').val($(iPulsado).attr('fn'));
            ...
            success: function (data) {
                if (data.returnValue == "") {
                    if ($("#Mode").val() == "E") {
                        ...
                        $(iPulsado).attr('fn', $('#Cuit').val());
                        $(iPulsado).attr('fn', $('#Telefono').val());
                        $(iPulsado).attr('fn', $('#ProvinciaID').val());
                        $(iPulsado).attr('fn', $('#Localidad').val());
                        $(iPulsado).attr('fn', $('#Observaciones').val());

                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Nombre]").html($('#Nombre').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Cuit]").html($('#Cuit').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Telefono]").html($('#Telefono').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=ProvinciaID]").html($('#ProvinciaID').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Localidad]").html($('#Localidad').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Observaciones]").html($('#Observaciones').val());
                    }
                    ...
                    if ($("#Mode").val() == "A") {
                        ...
                        item.PrecioCompra = $('#Cuit').val();
                        item.PrecioVenta = $('#Telefono').val();
                        item.nombre = $('#ProvinciaID').val();
                        item.PrecioCompra = $('#Localidad').val();
                        item.PrecioVenta = $('#Observaciones').val();
