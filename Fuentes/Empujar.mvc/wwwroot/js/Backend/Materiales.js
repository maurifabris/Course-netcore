    ...
    $("div[tipo=btnContainer]").on('click', 'i', function (e) {
        ...
        if (tipo == 'btnAdd' || tipo == 'btnEdit' || tipo == 'btnDel') {
            ...
            if (tipo == 'btnEdit') {
                ...
                $('#PrecioVenta').val($(iPulsado).attr('fn'));
                $('#PrecioCompra').val($(iPulsado).attr('fn'));
            ...
            success: function (data) {
                if (data.returnValue == "") {
                    if ($("#Mode").val() == "E") {
                        ...
                        $(iPulsado).attr('fn', $('#PrecioVenta').val());
                        $(iPulsado).attr('fn', $('#PrecioCompra').val());

                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=Nombre]").html($('#Nombre').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=PrecioVenta]").html($('#PrecioVenta').val());
                        $("div[numeral=" + $(iPulsado).attr('numeral') + "][tipo=PrecioCompra]").html($('#PrecioCompra').val());
                    }
                    ...
                    if ($("#Mode").val() == "A") {
                        ...
                        item.PrecioCompra = $('#PrecioCompra').val();
                        item.PrecioVenta = $('#PrecioVenta').val();
